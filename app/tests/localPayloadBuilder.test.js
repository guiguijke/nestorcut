...
const FIXTURE_B = {"input":{"files":[{"slug":"plate-s5t6u7.dxf","name":"plate.dxf","count":4,"parts":[{"coordinates":[[0,0],[100,0],[100,100],[0,100],[0,0]],"holes":[],"width":100,"height":100,"handles":[],"color":null}]}],"params":{"sheets":[{"width":1500,"height":1000,"count":1},{"width":2000,"height":1200,"count":2}],"space":0,"fillHoles":true,"addOutShape":true,"outputUnit":"inch"},"profile":{"timeBudgetSec":13,"vcores":1,"maxDirections":1,"level":"browser"}},"opened":{},"expected":{"payload":{"problem":"bpp","instance":{"name":"nest2d","items":[{"id":0,"demand":4,"allowed_orientations":[0,90,180,270],"shape":{"type":"simple_polygon","data":[[0,0],[100,0],[100,100],[0,100],[0,0]]}}],"bins":[{"id":0,"cost":100,"stock":1,"shape":{"type":"polygon","data":{"outer":[[0,0],[1500,0],[1500,1000],[0,1000],[0,0]]}}},{"id":1,"cost":160,"stock":2,"shape":{"type":"polygon","data":{"outer":[[0,0],[2000,0],[2000,1200],[0,1200],[0,0]]}}}]},"meta":null,"engineConfig":{"time_budget_sec":13,"prng_seed":"6526027723425558892","n_alternatives":3,"poly_simpl_tolerance":0.001,"min_item_separation":null,"narrow_concavity_cutoff":[0.01,0.01],"live_events":true,"n_workers":1,"plateau_patience_sec":2.2133333333333334,"separator_workers":1},"parts":[{"id":0,"file_slug":"plate-s5t6u7.dxf","handles":[],"color":"#BE185D","coords":[[0,0],[100,0],[100,100],[0,100],[0,0]],"holes":[],"count":4,"rotations":[0,90,180,270]}],"outputUnit":"inch","addOutShape":true,"hasHoles":false,"fillHoles":true},"seed":"6526027723425558892","itemMap":[{"id":0,"slug":"plate-s5t6u7.dxf","part":0}]}}
...
describe('C13 : formats count:0 filtrés, containerMapBack (audit 2026-09-03)', () => {
    it('une tôle vide au milieu ne casse pas les ids consécutifs', async () => {
        ...
        expect(out.payload.containerMapBack).toEqual([[0, 1], [1, 2]])

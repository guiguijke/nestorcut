...
export const DOCS_LANGS = ['en', 'fr', 'pt', 'it', 'de', 'es']
...
export const HELP_TOPICS = {
    sheets: { page: 'interface/', anchor: { en: 'the-sheets', fr: 'les-tôles', pt: 'as-chapas', it: 'le-lamiere', de: 'die-bleche' , es: 'las-chapas' } },
    spacing: { page: 'nesting/spacing/', anchor: { en: 'spacing', fr: 'lespacement', pt: 'o-espaçamento', it: 'la-distanza', de: 'der-abstand' , es: 'la-separación' } },
    rotations: { page: 'nesting/spacing/', anchor: { en: 'rotations', fr: 'les-rotations', pt: 'as-rotações', it: 'le-rotazioni', de: 'die-drehungen' , es: 'las-rotaciones' } },
    directions: { page: 'nesting/directions/', anchor: { en: 'the-three-directions', fr: 'les-trois-sens', pt: 'as-três-direções', it: 'le-tre-direzioni', de: 'die-drei-richtungen' , es: 'las-tres-direcciones' } },
    holes: { page: 'nesting/directions/', anchor: { en: 'parts-inside-holes', fr: 'les-pièces-dans-les-trous', pt: 'as-peças-nos-furos', it: 'i-pezzi-nei-fori', de: 'die-teile-in-den-löchern' , es: 'las-piezas-en-los-agujeros' } },
    badges: { page: 'nesting/', anchor: { en: 'what-the-badges-guarantee', fr: 'ce-que-garantissent-les-badges', pt: 'o-que-os-badges-garantem', it: 'cosa-garantiscono-i-badge', de: 'was-die-badges-garantieren' , es: 'lo-que-garantizan-las-insignias' } },
    offcut: { page: 'results/', anchor: { en: 'the-reusable-offcut--and-at-least', fr: 'la-chute-réutilisable--et--au-moins', pt: 'o-retalho-aproveitável--e-pelo-menos', it: 'il-ritaglio-riutilizzabile--e-almeno', de: 'das-nutzbare-restblech--und-mindestens' , es: 'el-sobrante-aprovechable--y-al-menos' } },
    alternatives: { page: 'results/', anchor: { en: 'the-alternatives', fr: 'les-alternatives', pt: 'as-alternativas', it: 'le-alternative', de: 'die-alternativen' , es: 'las-alternativas' } },
    downloads: { page: 'results/exports/', anchor: { en: 'what-downloads', fr: 'ce-qui-se-télécharge', pt: 'o-que-é-baixado', it: 'cosa-si-scarica', de: 'was-heruntergeladen-wird' , es: 'qué-se-descarga' } },
}

...
| **Écart sous l'espacement de la tôle DENSE (1,883 mm)** | Localisé le 10/09 : paire hôte/pièce nichée sur la tôle que la finition ne touche pas ; mesure discriminante puis correctif par règle, consigne fermée `PLAN-DERNIERE-TOLE-2026-09-09.md` §17 | **Tranché par l'owner le 10/09 : « ne me sera pas pardonné » → priorité 1** du reste à livrer |

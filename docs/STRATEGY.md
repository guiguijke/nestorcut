...
>
> Promesses privacy : `specs/THREAT-MODEL.md (private)` (état 2026-08-22). Contrôles
> techniques / pentest : `specs/CYBERSECURITY.md (private)`.
...
des promesses et threat model dans `specs/THREAT-MODEL.md (private)`.
...
5. **Binaire WASM récupérable par nature** : pas de licence check réseau
   ...
   (`specs/THREAT-MODEL.md (private)`). Le moat = produit, vitesse de shipping,
   confiance.

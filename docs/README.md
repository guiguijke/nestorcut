...
| [`PLAN-TAGS-IMAGES-2026-09-13.md`](PLAN-TAGS-IMAGES-2026-09-13.md) | `:latest` ne designe plus que ce qui a recu un GO (constat du 13/09 : la CI le deplacait a chaque poussee, donc un `compose pull` nu deployait des lots sans GO) ; lot D1, workflow manuel `promote-latest` |
| [`REPRISE-2026-09-13.md`](REPRISE-2026-09-13.md) | **Passation (13/09)** : état de la production, chantiers clos, priorité 4 en cours (J1-J3 GO, J4 à faire, recette SheetCam), première action (restaurer 86 fichiers QA), règles de la maison, outils, questions ouvertes |
...
| `PLAN-LANGUES-2026-09-16.md` | Quatre langues de plus (16/09) : portugais du Brésil, italien, allemand, espagnol — décision owner ; règle « complète ou rien », glossaire d'atelier et relecteur natif, socle L0, lots L1 à L4, après D4. |
- [PLAN-AUDIT-STABILISATION-2026-09-24.md](PLAN-AUDIT-STABILISATION-2026-09-24.md) — retrait de la promesse e-mail (M2), puis vague d'audit de stabilisation (AUD-1 à AUD-3) ; décision du propriétaire du 24/09

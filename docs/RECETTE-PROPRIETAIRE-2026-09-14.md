...
| # | Geste | Attendu | Verdict |
|---|---|---|---|
| C1 | Déposer `Piece_Trou+Fill_x4_OK.job` **avec** `Piece_Trou.DXF` et `Piece_Fillx4.DXF` | deux fiches (hôte ×1, éventail ×4), tôle 1000 × 1250 pré-remplie, kerf 1,5 et sécurité 1 ⇒ « espacement = 2 × kerf + sécurité = 4 mm » | |

...
export const import_file_limited: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
...
export const pinwheel_capacity: (a: number, b: number) => [number, number, number, number];

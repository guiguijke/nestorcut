...
> Référence crypto / cycle de vie. Promesses : `specs/THREAT-MODEL.md (private)`.
> Posture sécu : `specs/CYBERSECURITY.md (private)`. Le badge marketing Pro n'est
...
> transport HKDF — voir §2.2 et `specs/THREAT-MODEL.md (private)` §4).
